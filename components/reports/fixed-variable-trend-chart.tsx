...
import type { FixedVariableMonthBucket } from "@/lib/reports";
...
/** Despesas fixas x variáveis por mês (PRD §9/§32). */
export function FixedVariableTrendChart({ data }: { data: FixedVariableMonthBucket[] }) {
  return (
    <ResponsiveContainer width="100%" height={220}>
      <BarChart data={data} barGap={4}>
        ...
        <Bar dataKey="fixed" name="Fixas" stackId="fv" fill="var(--chart-2)" radius={[0, 0, 0, 0]} />
        <Bar dataKey="variable" name="Variáveis" stackId="fv" fill="var(--chart-5)" radius={[4, 4, 0, 0]} />
      </BarChart>
    </ResponsiveContainer>
  );
}
